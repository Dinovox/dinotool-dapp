...
export const FreezeAddress: React.FC<{
  isOpen: boolean;
  closeModal: () => void;
        ...
        <div className='bg-white rounded-lg max-h-[90vh] overflow-y-auto p-6 max-w-lg w-full shadow-lg'>
          <div className='flex justify-between items-center mb-4'>
            <h2 className='text-xl font-semibold'>
              {t('collections:freeze_wallet_for', {
          ...
          >
            {t('collections:freeze_wallet_info')}
            <div className='mb-4'>
              <label
                htmlFor='name'
                className='block text-sm font-medium text-gray-700'
              >
                {t('collections:address_to_freeze')}
              </label>
              <input
                type='text'
                id='address'
